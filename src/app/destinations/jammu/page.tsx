...
import { JAMMU_DESTINATION } from '@/data/regionalDestinations';
...
export default function JammuPage() {
	...
	const destination = JAMMU_DESTINATION;
		...
		<main className="min-h-screen bg-gray-50">
			...
			<section className="py-16 bg-white relative z-10 -mt-20">
				<div className="container mx-auto px-4">
					<motion.div
						...
						className={`${THEME.section.uniformBlue} rounded-3xl p-12 shadow-2xl`} 
					>
				...
				<div className="container mx-auto px-4">
					...
					>
						...
						<p className="text-xl text-gray-600 max-w-3xl mx-auto">
							Explore the sacred temples, majestic forts, and
							spiritual heritage of the City of Temples
						</p>
					</motion.div>
							...
							return (
								...
								>
									...
									<div className="absolute inset-0 opacity-5">
										<div
											className={`absolute ${isEven ? 'top-0 right-0' : 'bottom-0 left-0'} w-96 h-96 bg-amber-400 rounded-full blur-3xl`}
										/>
									</div>
										...
										>
											...
											>
												<div className="inline-flex items-center gap-2">
													<span
														className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold ${colorClass}`}
													>
														<IconComponent className="w-4 h-4" />
														{place.category
															.charAt(0)
															.toUpperCase() +
															place.category.slice(
																1
															)}
													</span>
												</div>
												...
												{/* View Tours CTA */}
												<Link
													href={`/tours?search=${encodeURIComponent('jammu')}`}
													className={`${THEME.button.primary} inline-flex items-center gap-2 px-6 py-3 hover:bg-amber-700 text-white font-semibold rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg group mt-6`}
												>
											...
											>
												<div className="relative group">
													<div className="absolute inset-0 bg-gradient-to-tr from-amber-600/20 to-orange-600/20 rounded-3xl transform rotate-3 group-hover:rotate-6 transition-transform duration-500" />
				...
				<div className="container mx-auto px-4 text-center relative z-10">
					...
					>
						...
						<h2 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
							Ready to Explore Jammu?
						</h2>
						<p className="text-xl md:text-2xl text-white/90 mb-12 leading-relaxed">
							Embark on a spiritual and cultural journey through
							the City of Temples with expert pilgrimage services
						</p>
						<div className="flex flex-col sm:flex-row gap-6 justify-center">
							<button
								onClick={() => setIsEnquiryModalOpen(true)}
								className={`${THEME.button.accent} group inline-flex items-center justify-center gap-3 px-10 py-5 bg-white font-semibold rounded-full hover:bg-gray-100 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-105`}
							>
								Enquire Now
								<ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
							</button>
						...
						<div className="mt-12 flex items-center justify-center gap-8 text-white/80">
							...
							<div className="flex items-center gap-2">
								...
								<span className="text-sm">8M+ Pilgrims</span>
							</div>
							<div className="w-1 h-1 bg-white/40 rounded-full"></div>
							<div className="flex items-center gap-2">
			...
			{/* <section className="py-16 bg-gray-50">
				<div className="container mx-auto px-4 max-w-7xl">
					<CustomItineraryCTA
						title="Plan Your Jammu Pilgrimage"
						description="Create your spiritual journey through Jammu! Visit sacred temples, explore heritage sites, and experience the City of Temples your way."
					/>
				</div>
			</section> */}
			...
			<EnquiryModal
				...
				tourTitle="Jammu Tours"
				tourId="jammu-destination"
			/>
		</main>
	);
}
